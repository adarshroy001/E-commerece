...
function AllCatg() {
  ...
  return (
    <div className="allCategories hidden lg:block">
      <div className='w-full min-w-[200px] flex justify-center relative z-50 p-2'>
          <Button className="!bg-mypink !rounded-3xl relative" onClick={handleToggleDropdown}>
            <div className="flex gap-2 pt-[2px] pb-[2px] items-center">
              ...
              <span className="text-white font-semibold text-[10px] xl:text-[12px]"> All Categories</span>
              <GoTriangleDown className="text-white text-lg mr-1" />
            </div>
          </Button>
          {isClicked && (
            <div className="subdropdown w-56 font-medium absolute left-0 top-[100%] bg-white  border border-solid border-[rgba(0,0,0,.1)] pt-4 pb-4 shadow-md z-50">
              <Link to="/Food">
